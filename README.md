...
答：本人现在在团队中担任技术核心角色，在业务上主要负责需求分析、讨论及确立，同时确定功能效果；在技术上主要负责整个项目框架的搭建，前端页面的开发，同时与后台开发人员协商，做好前后端整合。

###你认为怎样才是全端工程师（Full Stack developer）？
答：一开始我的理解比较肤浅，认为全栈工程师就是全能的，什么都能干，而且都很精通。从发现需求、分析需求、确立功能到UI设计、前端开发、服务器开发，再到最后项目运营，都能独自一人胜任。
而经过一段时间的了解后，我有了更深刻的认识。**真正的全栈工程师，善于发现生活中的问题，并以此问题利用自己的知识和能力去解决。在这个过程中，他不介意为此去学习任何领域的知识和技能。当他发现有人在某一方面比他能做得更好的时候，他会很热情的邀请其他人参与到他的项目上来，而非盲目的一挑独担。**

###介绍一个你最得意的作品吧？
答：我最得意的作品应该是“iCooc在线职业教育网站”。这是我做过的最大的一个项目，而大并非我得意的原因。我最喜欢它，在于我是从头到尾在做这个项目，到现在也是如此。这里所说的从头到尾，指的不是拿到需求文档然后开始开发，而是一切都是从无到有，从发现需求、分析需求、确立需求，然后到网站框架的搭建，到技术难题的攻破，甚至细小的代码bug，同时我们还不断的考虑网站的运营、推广与盈利。而这一切行动的初衷，只是为了为以后的学弟学妹们挥去前进道路的迷雾。这样子让我觉得，做这个网站真正让我觉得欣慰的地方并非自我能力提高了多少，而是我们正在做一件很有意义的事情。
